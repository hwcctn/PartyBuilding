<template>
  <el-card v-show="isShow">
    <div class="demo-fit">
      <div class="block">
        <el-avatar shape="square" class="custom-avatar" fit="fill" src="https://img2.baidu.com/it/u=717423697,1047943915&fm=253&fmt=auto&app=138&f=JPEG?w=800&h=1067" />
      </div>
    </div>
    <div class="info">
...
const info = ref({
  ...
  resume: `2011年9月——2014年9月  就读于重庆市荣昌县初级中学校 学生； 2014年9月——2017年9月  就读于重庆市暨华中学校 学生；2017年9月——2021年9月  就读于重庆市邮电大学移通学院 学生；2023年9月——至今  就读于桂林电子科技大学 学生。`
});
